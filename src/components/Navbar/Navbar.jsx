...
//   return (
//     <header className="fixed top-0 left-0 w-full z-[999] bg-gray-900/95 backdrop-blur-md md:bg-transparent md:backdrop-blur-none">
...
export default function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const scrollPosition = window.scrollY + 100; // 100 px offset for header height
